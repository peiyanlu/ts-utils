...
[![build](https://img.shields.io/github/actions/workflow/status/peiyanlu/ts-utils/test.yaml?branch=master&logo=github)](https://github.com/peiyanlu/ts-utils/actions)
[![coverage](https://coveralls.io/repos/github/peiyanlu/ts-utils/badge.svg?branch=master)](https://coveralls.io/github/peiyanlu/ts-utils?branch=master)

> 🧩 A lightweight TypeScript utility library with powerful type helpers and runtime tools.

## ✨ Features

- 🔠 Advanced type utilities (e.g. `Mutable`, `Optional`, `RequireAtLeastOne`)
- ⚙️ Runtime helpers (`omit`, `isInstanceOf`, `asInstanceOf`)
- 🧱 Zero dependencies, written in pure TypeScript (ESM compatible)
